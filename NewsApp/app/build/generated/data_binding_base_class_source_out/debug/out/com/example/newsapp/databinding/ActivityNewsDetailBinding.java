...
public final class ActivityNewsDetailBinding implements ViewBinding {
  ...
  private ActivityNewsDetailBinding(@NonNull LinearLayout rootView, @NonNull Toolbar toolbar,
  ...
  public static ActivityNewsDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewsDetailBinding((LinearLayout) rootView, toolbar, webView);
    }
